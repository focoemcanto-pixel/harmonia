    ...
    <main>
      ...
      <section className="hero-original">
        <div className="container narrow center">
          ...
          <h1>Aprenda a Dividir Voz no Louvor — Oferta Especial por Tempo Limitado</h1>
          <p className="lead">Essa condição especial encerra em breve. Não perca a chance de transformar seu canto no ministério.</p>
          ...
          <a className="button primary wide" href={checkoutUrl} target="_blank" rel="noreferrer">QUERO APROVEITAR AGORA</a>
      ...
      <section className="section transform-section">
        <div className="container split reverse-mobile">
          ...
          <div>
            ...
            <p>O Foco em Harmonia foi criado para desbloquear sua habilidade de dividir vozes com um caminho simples, progressivo e fácil de aplicar — aproveite essa condição promocional enquanto ela está ativa.</p>
      ...
      <section className="section offer-section">
        <div className="container narrow center">
          ...
          <div className="offer-price-block">
            <p className="offer-discount-badge">🔥 75% OFF — OFERTA RELÂMPAGO</p>
            ...
            <p className="offer-savings">Essa oferta pode encerrar a qualquer momento</p>
          </div>
